...
public class TypeView extends HBox {
    ...
    public TypeView() {
        ...
        try {
            Image image2 = new Image(new FileInputStream("images//images (2).jpg"));
        ...
        try {
            Image image3 = new Image(new FileInputStream("images//images (1).jpg"));
        ...
        try {
            Image image4 = new Image(new FileInputStream("images//images.jpg"));
